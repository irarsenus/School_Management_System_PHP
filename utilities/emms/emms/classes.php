                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="add_class.php" class="btn btn-info"> + Add Class</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example5" class="display table table-bordered" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="class_edit.php?id=<?php echo $row['id'] ?>" class="btn btn-primary"><i class="bi bi-pencil-square"></i></a>
                                                    <a href="class_del.php?id=<?php echo $row['id'] ?>" class="btn btn-danger"><i class="bi bi-x-lg"></i></a>
                                                </td>
                                            </tr>
