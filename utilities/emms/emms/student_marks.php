...
<body>
    ...
    ***********************************-->
    ...
    <div id="main-wrapper">
        ...
        <?php include 'dashboard/student_header.php' ?>
            ...
            <div class="container-fluid mt-5">
            	...
            	<div class="col-lg-12">
						...
						<a href="student_marks.php?term=1" class="btn btn-outline-primary">Term1</a>

						<a href="student_marks.php?term=2" class="btn btn-outline-primary">Term2</a>

						<a href="student_marks.php?term=3" class="btn btn-outline-primary">Term3</a>
