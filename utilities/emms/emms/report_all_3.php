...
<head>
	...
	<title><?php echo $class ?>   •   Term <?php echo $term ?>  •  Reports</title>
...
<body style="font-family: sans-serif;">
	<?php
	while ($student=mysqli_fetch_assoc($select)){	
	...
	<fieldset style="border: 2px solid black;">
		...
		<div class="container">
			...
			<div class="footer">
				...
				<p style="margin-left: -80px;"><b><u>SCHOOL MANAGER</u></b></p>
				<p style="margin-left: -60px;"><b>GATARI SLYVERE</b></p>
...
$conduct= $student['conduct'];	
	...
	<fieldset style="border: 2px solid black;">
		...
		<div class="container">
			<div class="location">
				<p style="font-size: 15px; line-height: 10px;"><b>REPUBLIC OF RWANDA</b></p>
				<p style="font-size: 15px; line-height: 10px;"><b>MINEDUC</b></p>
				<p style="font-size: 15px; line-height: 10px;"><b>PROVINCE:KIGALI CITY</b></p>
				<p style="font-size: 15px; line-height: 10px;"><b>DISTRICT:KICUKIRO</b></p>
				<p style="font-size: 15px; line-height: 10px;"><b>SCHOOL NAME:ESSA NYARUGUNGA</b></p>
				<p style="font-size: 15px; line-height: 10px;"><b>P.O.BOX 3806</b></p>
				<p style="font-size: 15px; line-height: 10px;"><b>TEL:0788303811</b></p>
				<p style="font-size: 15px; line-height: 10px;"><b>E-mail:essanyarugunga@yahoo.com</b></p>
			</div>
