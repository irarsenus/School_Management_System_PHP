        ...
        <div class="dlabnav">
            ...
            <div class="dlabnav-scroll">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="ai-icon" href="admin_dash_bursar.php" aria-expanded="false">
                    ...
                    <li>
                        ...
                        <a class="ai-icon" href="bursar_students_select.php" aria-expanded="false">
                    ...
                    <li>
                        ...
                        <a class="ai-icon" href="bursar_classes.php" aria-expanded="false">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <!-- <li><a href="bursar_division_select.php">All Students</a></li> -->

                            <li><a href="bursar_class_select.php">Class Select</a></li>

                            <li><a href="bursar_fees_structure.php">Fees Structure</a></li>
