                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                ?>
                                    <a href="bursar_students_print.php?class=<?php echo $_GET['class'] ?>&level=ol" class="btn btn-primary bi bi-printer float-start"></a>
                                <?php }else{ ?>
                                    <a href="bursar_students_print.php?class=<?php echo $_GET['class'] ?>&level=al" class="btn btn-primary bi bi-printer float-start"></a>
                                <?php } ?>
