                                        ...
                                        <div class="tab-content">
											<div id="my-posts" class="tab-pane fade active show">
                                                <div class="my-post-content pt-3">
                                                	...
                                                	<form name="post" method="POST" action="parent_post.php" style="padding: 10px; box-shadow: 0px 0px 9px;" class="rounded">
                                                        <h3 class="text-muted">Create Post</h3>
                                                        <hr>
	                                                	<div class="post-input">
                                                            <div class="form-group">
                                                                <label>Name:</label>
                                                                <input class="form-control" type="text" name="parent" placeholder="Enter your name..." required>
                                                            </div>
                                                            <label>Message:</label>
	                                                        <textarea name="post" id="textarea" cols="30" rows="10" style="height: 200px;" class="form-control bg-transparent" placeholder="Tell us what is on your mind..." maxlength="250" required></textarea>
