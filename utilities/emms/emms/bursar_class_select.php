        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <!-- <a href="bursar_fees_structure.php" class="btn btn-warning mr-5">Fees Structure</a> -->
                </div>
                ...
                <div class="row">
                    ...
                    if (mysqli_num_rows($select)) {
                        ...
                        while ($row=mysqli_fetch_assoc($select)) {
                            ...
                            if ($row['division'] == "A'LEVEL") {

                    ?>



                    <a href="bursar_fees.php?class=<?php echo $row['class'] ?>&level=al&term=1" class="col-xl-3 col-xxl-3 col-sm-6">
                ...
                <?php }else{ ?>
                    ...
                    <a href="bursar_fees.php?class=<?php echo $row['class'] ?>&level=ol&term=1" class="col-xl-3 col-xxl-3 col-sm-6">
