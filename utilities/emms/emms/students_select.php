        ...
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <a href="students.php?class=<?php echo $row['class'] ?>&level=al" class="col-xl-3 col-xxl-3 col-sm-6">
                ...
                <?php }else{ ?>
                    <a href="students.php?class=<?php echo $row['class'] ?>&level=ol" class="col-xl-3 col-xxl-3 col-sm-6">
                        <div class="widget-stat card bg-primary">
                            <div class="card-body">
                                <div class="media">
                                    <div class="media-body text-white">
